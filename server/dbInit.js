...
var dbInit = function () {
  sql.connect(function (err) {
    if (err) {
      ...
      sql.query('CREATE TABLE thingsToDo (things_id int(11) NOT NULL AUTO_INCREMENT,user_id int(11) NOT NULL,thingstodo varchar(500) NOT NULL,create_date datetime DEFAULT NULL,dead_time datetime DEFAULT NULL,PRIMARY KEY (things_id), UNIQUE (user_id), CONSTRAINT `thingstodo_ibfk_1` FOREIGN KEY (user_id) REFERENCES users (user_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;', function (err) {
